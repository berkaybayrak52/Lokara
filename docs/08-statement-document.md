...
development-synchronized and locally merged; C3b jobs and the C3c landlord *Zahlungen* screen remain
open, and renter delivery/portal remains M10. These archives are owner-only technical
...
service is technically complete, development-synchronized and locally merged; C3b jobs remain
open. The live landlord preview still omits
...
- **Remaining M6:** C3b's three job entrypoints and C3c's landlord *Zahlungen* screen. C3a is
  technically complete, development-synchronized and locally merged; renter delivery/portal is
  M10.
