...
It owns the calculation boundary handed to approved `docs/11` and current `docs/14`; it does not own
...
Approved `docs/11` owns all Anlage-V line mappings, SKR03/SKR04 accounts, DATEV EXTF,
export archive, readiness and tax-year form data. It consumes the Page-03 handoff without
recalculation. `docs/14` owns future net/return/DSCR/cashflow planning formulas, the twelve-month
annuity schedule, sensitivity scenarios and the tax rate as a scenario input. It does not override
Page-03 AfA or deductible-interest truth; the R13-interest versus planning R3-interest choice
remains unresolved.
